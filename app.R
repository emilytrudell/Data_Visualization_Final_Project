...
server <- function(input, output) {
  ...
  isc_fill_group_risk_txt   <- renderText({if (isc_fill_points()==0) {"1% of patients without an inhaled steroid combination medication prescription the last 12 months have an asthma exacerbation in the next 12 months"} 
    else {"28% of patients who have been prescribed a inhaled steroid combination medication in the last 12 months have an asthma exacerbation in the next 12 months, 22 times the risk of those without a prescription"} })
  ...
  os_fill_group_risk_txt   <- renderText({if (os_fill_points()==0) {"1% of patients without an oral steroid medication prescription the last 12 months have an asthma exacerbation in the next 12 months"} 
    else {"10% of patients who have been prescribed a inhaled steroid combination medication in the last 12 months have an asthma exacerbation in the next 12 months, 10 times the risk of those without a prescription"} })
